                                    ...
                                    <div className="col-lg-7 col-md-7">
                                        <div className="slider-content s-slider-content mt-80 text-center">
                                            ...
                                            <p
                                                ...
                                                data-delay=".6s"
                                            >
                                                Donec vitae libero non enim
                                                placerat eleifend aliquam erat
                                                volutpat. Curabitur diam ex,
                                                dapibus purus sapien, cursus sed
                                                nisl tristique, commodo gravida
                                                lectus non.
                                            </p>
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="single-services mb-30">
                                    ...
                                    <div className="services-content">
                                        ...
                                        <p>
                                            Aenean vehicula ligula eu rhoncus
                                            porttitor. Duis vel lacinia quam.
                                            Nunc rutrum porta place ullam ipsum.
                                            Morbi imperdiet, orci et dapibus.
                                        </p>
                                        <div className="icon">
                                            <ul>
                                                <li>
                                ...
                                <div className="single-services mb-30">
                                    ...
                                    <div className="services-content">
                                        ...
                                        <p>
                                            Aenean vehicula ligula eu rhoncus
                                            porttitor. Duis vel lacinia quam.
                                            Nunc rutrum porta ex, in imperdiet
                                            tortor feugiat at.
                                        </p>
                                        <div className="icon">
                                            <ul>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="services-08-item mb-30">
                                    ...
                                    <div className="services-08-content">
                                        ...
                                        <p>
                                            Nullam molestie lacus sit amet velit
                                            fermentum feugiat. Mauris auctor
                                            eget nunc sit amet.
                                        </p>
                                        <Link to="/service-details">
                                            Read More{" "}
                    ...
                    <div className="container">
                        <div className="row justify-content-center align-items-center">
                            <div className="col-lg-4 col-md-12">
                                ...
                                <p>
                                    Proin consectetur non dolor vitae pulvinar.
                                    Pellentesque sollicitudin dolor eget neque
                                    viverra, sed interdum metus interdum. Cras
                                    lobortis pulvinar dolor, sit amet
                                    ullamcorper dolor iaculis vel
                                </p>
                                <p>
                                    Cras finibus laoreet felis et hendrerit.
                                    Integer ligula lorem, finibus vitae lorem
                                    at, egestas consectetur urna. Integer id
                                    ultricies elit. Maecenas sodales nibh, quis
                                    posuere felis. In commodo mi lectus
                                    venenatis metus eget fringilla. Suspendisse
                                    varius ante eget.
                                </p>
                            </div>
                            <div className="col-lg-4 col-md-6">
                            ...
                            <div className="col-lg-12">
                                ...
                                >
                                    <div className="single-testimonial">
                                        ...
                                        <p>
                                            “Phasellus aliquam quis lorem amet
                                            dapibus feugiat vitae purus vitae
                                            efficitur. Vestibulum sed elit id
                                            orci rhoncus ultricies. Morbi vitae
                                            semper consequat ipsum semper quam”.
                                        </p>
            ...
            {sidebar && (
                <>
                    <div className={`offcanvas-menu ${sidebar && "active"}`}>
                        ...
                        <div
                            id="cssmenu3"
                            className="menu-one-page-menu-container"
                        >
                            <ul id="menu-one-page-menu-2" className="menu">
                                ...
                                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                                    <Link to="/gallary">Gallery Study</Link>
                                </li>
                                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                        ...
                        <div
                            id="cssmenu2"
                            className="menu-one-page-menu-container mt-100"
                        >

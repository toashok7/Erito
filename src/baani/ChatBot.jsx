  ...
  render() {
    ...
    return (
      <div className={`rsc ${className}`}>
        ...
        <HelmetProvider>
          <Helmet>
            <title>Ask your certification queries </title>
            <meta
              name="description"
              content="Vaskk brings interactive learning experience for the preparation of Cloud certification exam. You will learn key tips to pass the exam successfully, how to schedule an exam, exam pricing. This site also share inputs on some of the exam preparation material which can be helpful to gain knowledge and pass the certification exam successfully."
            />

            <link rel="canonical" href="https://www.vaskk.com/" />
          </Helmet>
          <ChatBotContainer
